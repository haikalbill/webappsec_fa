  ...
  <body ononline="onFunction()" onoffline="offFunction()">
    <nav>
      ...
      <ul class="list-link-container">
        ...
        <li><a class="active" href="Facility.php">Facility</a></li>
    ...
    <script>
      ...
      // Add XSS protection to user input
      ...
      // Example usage: sanitize user input before displaying it
      const userInput = '<?php echo sanitizeInput($_POST['user_input']); ?>';
